    ...
    return (
        <section className="bg-white dark:bg-gray-900 p-16">
            <div className="py-8 px-4 mx-auto max-w-screen-lg lg:py-16 lg:px-12">
                ...
                <h2 className="mb-4 mt-10 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                    Installation
                </h2>
                <p className="text-gray-500 sm:text-lg dark:text-gray-400 ">
                ...
                <ol className="list-decimal list-inside">
                    <li className="text-gray-500 sm:text-lg dark:text-gray-400 my-1">
